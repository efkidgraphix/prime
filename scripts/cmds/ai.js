...
async function a(api, event, args, message) {
  try {
    ...
    const b = "from now on your name is prime, and u where creatd by a teen who loves programming named 'Frank' ,u should always answer in a cool way and in a slangy way,"; // the more better content you give the  best it became
    const c = await d(a, b);
